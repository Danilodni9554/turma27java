...
insert into tb_pizza (sabor, preco, categoria_id) values ("Calabresa", 45.90, 2);
insert into tb_pizza (sabor, preco, categoria_id) values ("Frango com catupiry", 49.90, 2);
